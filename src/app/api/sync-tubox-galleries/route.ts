...
// Die korrekte URL zur listfiles.php im Partycrasher/uploads-Verzeichnis
const TUBOX_LIST_URL = "https://tonbandleipzig.de/Partycrasher/uploads/listfiles.php";
...
export async function GET() {
  try {
    ...
    const BASE_URL = "https://tonbandleipzig.de/Partycrasher/uploads/";
